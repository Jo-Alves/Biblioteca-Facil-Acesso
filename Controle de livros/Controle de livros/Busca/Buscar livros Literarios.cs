...
{
    public partial class Buscar_livros_Literarios : Form
    {
        public Buscar_livros_Literarios()
        {
            InitializeComponent();
            cb_Titulo.Focus();           
        }
        ...
        {
            VerificarLivroLiterarioEmprestado vle = new VerificarLivroLiterarioEmprestado(cb_Titulo.Text);
            vle.ShowDialog();
        }
