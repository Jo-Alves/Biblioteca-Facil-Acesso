...
{
    public partial class FrmRelatorioLivroEmprestadoLiterarioPorTurma_E_Ano : Form
    {
        public FrmRelatorioLivroEmprestadoLiterarioPorTurma_E_Ano()
        {
            InitializeComponent();
        }
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (cbAno.SelectedIndex >= 0)
            {
                ...
                this.tabelaEmprestimoLivroLiterarioTurmaEAnoTableAdapter.Fill(this.dataSet_Emprestimo2.TabelaEmprestimoLivroLiterarioTurmaEAno, cbAno.Text, cbTurma.Text);
