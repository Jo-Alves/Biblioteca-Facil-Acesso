            ...
            else
            {
                if (lbl_Verificar.Text == "Usuario e senha correta!")
                {
                    if (txt_SenhaAtual.Text == txt_Senha.Text)
                    {
                        ...
                        MessageBox.Show("A senha não confere!", "Biblioteca Fácil", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
                else
                    MessageBox.Show("Este usuário não existe!", "Biblioteca Fácil", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }     
