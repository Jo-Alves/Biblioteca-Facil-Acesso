...
{
    public partial class FrmRelatorioEmprestimoLivroLiterarioPorTurma_E_Ano : Form
    {
        public FrmRelatorioEmprestimoLivroLiterarioPorTurma_E_Ano()
        {
            InitializeComponent();
        }
        ...
        { 
            if (cbAno.SelectedIndex >= 0)
            {
                ...
                this.emprestimoLivroLiterarioTurmaEAnoTableAdapter.Fill(this.dataSet_Emprestimos.EmprestimoLivroLiterarioTurmaEAno, DateTime.Now.ToShortDateString(), cbAno.Text, cbTurma.Text);
